        ...
        <!-- /.container-fluid -->
			...
			<div class="container" style="margin:8% auto;">
				<div class="col-sm-4 col-md-3">
					...
					<p>Discussion forums are a quite popular question and answers based website for any type of queries. It allows 
					the access only to both registered. The users can ask or answer the
					questions and can discuss various alternate answers..</p>
				</div>
